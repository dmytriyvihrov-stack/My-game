...
|---|---|
| **Race** | what they were born as |
| **Class** | what they learned to do |
| **Personality** | how they behave |
| **Scar** | what violence did to them |
| **Mutation** | what the strange parts of the world changed them into |
...
## What mutations must NOT become

No mutation tree. No mutation points. No mutation merchant. No catalogue of selectable limbs. No
...
6–10 possible origins exist in the content; a normal run meets **1–2**; many runs end with none.
One major mutation per character (a second should evolve the first). Never from routine camping or
ordinary fights. Mutated enemies stay unusual too. **If every company has three mutants, this has
become a class system and failed.**

## Stages (a story, not a tree)

Some mutations develop in 2–3 stages: Coloured Nail (cosmetic, senses the Bloom, removable) →
Blooming Hand (grasping action, no weapon in that hand, removal now costs the hand) → The Hand
Chooses (acts on its own, cannot be hidden or reversed). The feeling: *"I can see where this is
...
| Mutation | One line |
|---|---|
| **Gills of the Fen** ✅ built | water accepts them; dry country does not |
| **Blooming Hand** ✅ built | reaches farther than its owner intends |
| The Second Shadow | sometimes it stays where they were |
| The Talking Wound | useful when it tells the truth |
| The Eye Beneath the Tongue | sees what speech must hide (using it costs the voice) |
| Bone Lantern | a light that does not belong inside anyone |
| Hollow Belly | always full of room |
| Reed Lungs | the marsh kept part of every breath |
| Borrowed Face | resembles whoever is most inconvenient |
| Splinter Bones | harder to break, easier to burn |
| Bell Heart | rings loudest when afraid |
| Long Fingers | can reach most things, including trouble |
| Glass Skin | beautiful from a distance, dangerous up close |
| The Quiet Mouth | says nothing; something still answers |
| The Backward Knee | leaves fights more easily than it enters them |
| Crown of Antennae | feels everything coming and wishes it did not |

And fifteen conditions feeding them: Fen-Water in the Lungs ✅, Colour Beneath the Nail ✅, Bloom
Fever, Something in the Wound, Bell-Sick, Mirror Sleep, Reed Cough, Hollow Hunger, Glass Cracks,
Rooted Blood, Watched from Inside, Wrong Voice, Skin Full of Light, Unfinished Drowning, The
Extra Pulse.

### The two chains as built
...
the shadow sometimes does; **Has No Stomach for It + Hollow Belly** is horrified by what its body
wants. That collision is where the memorable people come from.

## Equipment

One simple rule, no fitting spreadsheet: the affected slot **works / works poorly with one funny
specific line / is unavailable.** *"The helmet fits. The gills do not. Something must remain
outside."*

## Removal

Hard, story-shaped, never at an ordinary healer: sacrifice the limb, a personal quest, a
specialist who wants something unpleasant, the once-per-run wagon resource, trade the mutation for
a scar. Removal is itself an event: *"She can remove the Blooming Hand. She cannot promise there
will still be an arm beneath it."*
...
```text
NAME: / TYPE: condition | mutation | stage / ORIGIN: / VISIBLE CHANGE: / SHORT SHEET TEXT:
BATTLE EFFECT: one unique rule + supporting details
COST: inseparable drawback + equipment/positioning consequences
ROAD EFFECT: event options · social reactions · terrain interactions
RACE VARIANTS: HUMAN / RATKIN / OGRE
PERSONALITY REACTIONS: optional examples
PROGRESSION: what leads in · what it may become · how it may be treated
ART NOTE: what changes on portrait/token · which saturated colour, if any
```

## The test

Not "is it balanced." The test is: **after the run, does the player remember who received it and
how it happened?** If they remember the bonus but not the person, the system has failed.
