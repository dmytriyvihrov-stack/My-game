...
*(#86 is claimed by the clarity pass in the backlog; #87 shipped 2026-08-10. **Before taking a
number, grep the build log AND all four docs AND the prototype.** Five collisions have happened
here, because the code is written before the docs are - **#87 is the fifth: it was written as #86
and renumbered after the fact**, because a parallel session had claimed #86 and taken 8f.115 the
same day.)*
...
69 · 70 · 71 · 72 · 73 · 74 · 75 · 76 · 77 · 79 · 81 · 82 · 83 · 84 · 85 · 87
