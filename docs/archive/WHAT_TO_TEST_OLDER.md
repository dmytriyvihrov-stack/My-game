# What to test - the older sections (reference)

> **Everything that shipped on 2026-08-02 and before.** Moved out of
> [`WHAT_TO_TEST.md`](../WHAT_TO_TEST.md) on **2026-08-10** so the live test bench holds only what
> is actually waiting for you.
>
> **Nothing here was deleted and nothing was edited.** Most of it has been through the QA
> playthrough of 2026-08-02 or through your own runs. If you want to test one of these again, it
