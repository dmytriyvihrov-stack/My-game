...
analysis so the current wagon can keep working until this replaces it.)*

## The problem with the current model

Salvage is abstract: *find iron → carry it to the end → someday buy a permanent wagon bonus.* It
works, but it is weakly connected to the adventure that produced it, and it lives in a menu between
runs rather than in the world. Three passive bonuses on a cart is a small tree wearing a costume.

## The economy, by horizon
...
The key change: **materials get spent NOW, inside the story.** Reforge a weapon, plate somebody's
armour, repair the village forge, build an infirmary, strengthen the gate before an attack, widen
the wagon, unlock a service, prepare for the boss.
...
That last one is the model for all of them: **a building should change the scene, not a number.**

## What crosses into the next run

Not the buildings. Carrying full built power forward produces the standard metaprogression failure:
...
- the smith is *known*
- a blueprint is *open*
- the first repair is free
- you start with one forge tool
- a forge node is *guaranteed* on the next map

**What transfers is possibility, not power.** The world remembers the previous company; the new one
does not inherit its strength.

## The inheritance screen

At the end of a run the player picks **one** thing that survived: a blueprint · a tool · an
acquaintance · part of a building · a person · a company tradition · one gem · a story that opens a
new event.
...
Not "a rare currency with a big number." A gem lets you do something the rules forbid: finish a
building with no materials · **keep a building between runs** · remove a heavy scar · pass a dead
character's weapon or ability to somebody else · open the forbidden part of the forge · buy a strong
item · or sell it and save the company from starving.

The axis: **spend it to survive now, or invest it in what outlasts the company.**
